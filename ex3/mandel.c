...
/*	1.
	...
	(thrcnt), ο	οποίος δίνεται μέσω του command line απο τον χρήστη.
	...
	πάρει άδεια από το προηγούμενο	νήμα ή εάν πρόκεται για το πρώτο
	...
	Για να το αποφύγουμε αυτό, χρησιμοποιύμε έναν signal handler
