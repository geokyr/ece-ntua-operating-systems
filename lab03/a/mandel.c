...
/*	1.
	...
	4.
	Εάν πατήσουμε Ctrl-C την ώρα που εκτελείται το πρόγραμμα,
	σταματάει η εκτύπωση του Mandelbrot και δεν γίνεται reset στο
	χρώμα της γραμματοσειράς του τερματικού	μας και επομένως, το 
	τερματικό μας μετά την έξοδο μένει με το χρώμα του τελευταίου
	χαρακτήρα που είχε εκτυπωθεί κατά τηνεκτέλεση του προγράμματος.
